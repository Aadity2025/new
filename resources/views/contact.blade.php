...
<section class="ss_map">
	<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3888.003180997419!2d77.59336177460384!3d12.971648014878172!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae16775069abf7%3A0xe138768bb2a0df8a!2sUB%20City!5e0!3m2!1sen!2sin!4v1702216772238!5m2!1sen!2sin" frameborder="0" style="border:0" allowfullscreen></iframe>
</section>
...
<section class="ss_contact ss_section_sec_bg spacer_bottom"> <!--===== Form Section Start =====-->
				...
				<div class="col-lg-4 col-md-5">
					<div class="ss_contact_left">
						<div class="ss_contact_one">
							...
							<h2>Address:</h2>
							<p>Level 10, UB City concorde tower, Vittal Mallya Road, Bangalore, Karnataka 560001.</p>
				...
				<div class="col-lg-8 col-md-7">
					<div class="ss_contact_right">
						...
						<form >
							...
							<div class="ss_contact_form">
								<label>Subject</label>
								<input type="text" name="subject" id="subject" placeholder="Enter your subject" class="require" />
							</div>	
							<div class="ss_contact_form">
	...
	<section class=""> <!--===== Section Product Start =====-->
		<div class="container-fluid">
			<div class="row" style="justify-content: center;"> 
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="ss_six_product wow fadeIn" data-wow-delay="0.1s" data-wow-duration="1s">
						<div class="ss_six_p_img ss_box_bg">
							<img class="img-fluid" src="https://www.kembotlubes.com/assets/images/resource/image-104.jpg" alt="image" />
						</div>	
						<div class=" ss_box_bg">
							
							<h2>United Arab Emirates </h2>
							<p>HDS Business Towers, Tower Cluster M1 33rd Floor, Jumeirah lake Towers, Dubai Dubai ARE </p>
				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="ss_six_product wow fadeIn" data-wow-delay="0.1s" data-wow-duration="1s">
						<div class="ss_six_p_img ss_box_bg">
							<img class="img-fluid" src="https://www.kembotlubes.com/assets/images/resource/image-105.jpg" alt="image" />
						</div>	
						<div class=" ss_box_bg">
							
							<h2>South Africa</h2>
							<p>Harbour View Building Oakworth Road 1st Floor Humewood, Port Elezibeth 6001, ZAF.</p>
				...
				<div class="col-lg-3 col-md-6 col-sm-6">
					<div class="ss_six_product wow fadeIn" data-wow-delay="0.1s" data-wow-duration="1s">
						<div class="ss_six_p_img ss_box_bg">
							<img class="img-fluid" src="https://www.kembotlubes.com/assets/images/resource/image-103.jpg" alt="image" />
						</div>	
						<div class="ss_box_bg">
						
							<h2>United Kingdom</h2>
							<p>6 St. George’s Way St. George’s House 3rd Floor
								Leicester, Leicestershire, LE1 1QZ, GBR</p>
